...
- `broad`：宽泛。适合人物核心人设、背景故事、家庭关系、主线经历等需要常被参考的资料。
- `normal`：普通。适合排序、能力、生活习惯、关系补充等中等重要资料。
- `strict`：严格。适合小段子、条件剧情、性相关细节、可能发生、很具体的事件，能明显减少误触发。
